...
const OBS_COLS_DEF = `__OBS_COLS_DEF__`;
const EMP_COLS_DEF = `__EMP_COLS_DEF__`;
const VERIFY_COLS_DEF = `__VERIFY_COLS_DEF__`;
const CLINIC_COLS_DEF = `__CLINIC_COLS_DEF__`;
const LINK_COLS_DEF = `__LINK_COLS_DEF__`;
