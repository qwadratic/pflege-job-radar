...
def crawl(c, towns, log=None):
    ...
    for j in jobs:
        ...
        obs.append({
            ...
            "department_hint": j["department"] or department_hint(title, desc), "department_raw": j["department"],
            "city": town, "plz": None, "region": None, "lat": None, "lon": None,
            "in_bavaria": in_bavaria(town, None, None, towns), "n_locations": 1,
